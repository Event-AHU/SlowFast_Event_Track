...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='fe240', help='eventvot or coesot or fe108 or visevent or eed.')
    parser.add_argument('--parameter_name', type=str, default='ostrack_fe240', help='eventvot or coesot or fe108 or visevent or eed.')
    ...
    """hdetrack"""
    trackers.extend(trackerlist(name='ostrack', parameter_name=args.parameter_name, dataset_name=dataset_name,
                                run_ids=None, display_name='Slow_Fast'))
