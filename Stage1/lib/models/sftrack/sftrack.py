...
from lib.models.sftrack.vit import vit_base_patch16_224
from lib.models.sftrack.vit_ce import vit_large_patch16_224_ce, vit_base_patch16_224_ce
from lib.models.sftrack.vit_ce_fast import vit_base_patch16_224_ce_fast
...
class Slow(nn.Module):
    """ This is the base class for Slow Tracker """
...
class Fast(nn.Module):
    """ This is the base class for Fast Tracker """
...
def build_sftrack(cfg, training=True):
    current_dir = os.path.dirname(os.path.abspath(__file__))  # This is your Project Root
    pretrained_path = os.path.join(current_dir, '../../../pretrained_models')
    if cfg.MODEL.PRETRAIN_FILE and ('SFTrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    if 'SFTrack' in cfg.MODEL.PRETRAIN_FILE and training:
