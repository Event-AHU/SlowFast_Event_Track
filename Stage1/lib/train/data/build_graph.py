...
class Build_Graph(nn.Module):
    ...
    def for_in_bbox(self, bin_event, gt_bbox, W, H, ratio, return_multi_results):
        ...
        if return_multi_results:
            ...
            pos = event_sub[:, :3]
            edge_index = knn_graph(pos, k=8) # avg_time: 0.004480512142181397
            # edge_index = radius_graph(pos, r=3.0, max_num_neighbors=32) # avg_time: 0.013471155166625977
    ...
    def generate_graphs_from_event(self, event_sub):
        ...
        for i in range(3):
            ...
            # edge_index = radius_graph(pos, r=3.0, max_num_neighbors=32)
