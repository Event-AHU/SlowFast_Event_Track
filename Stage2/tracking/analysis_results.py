...
if __name__ == '__main__':
    ...
    parser.add_argument('--parameter_name', type=str, default='sftrack_fe240', help='eventvot or coesot or fe108 or visevent or eed.')
    ...
    """hdetrack"""
    trackers.extend(trackerlist(name='sftrack', parameter_name=args.parameter_name, dataset_name=dataset_name,
